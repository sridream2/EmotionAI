...
PREDICTED_LABELS = ["angry", "disgust","fear","happy","neutral","sad","surprise"] #edit1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/28e62543-b365-4eeb-829b-333008b8d0f9'  #Edit 2
...
st.title("Emotion Prediction AI")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("Predict the Mood of the Person in Picture")#change according to your project   #edit 3
  #setting up the subheader
  st.subheader("File Uploader")#change according to your project

  #file uploader
  image = st.file_uploader(label="Upload an image of a person to predict his/her emotion",accept_multiple_files=False, help="Upload an image to classify them")
  if image:
...
with tab2:
  ...
  #add github link
  st.link_button("My Github Repository", "https://github.com/sridream2/EmotionAI") #Edit3
  ...
  pdf_url = "https://raw.githubusercontent.com/sridream2/EmotionAI/main/sample.pdf"  #edit4
